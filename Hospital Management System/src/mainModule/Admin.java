        ...
        if (option1 == 2) {
            ...
            if (option == 2) {
                ...
                if (CommunityDoctor.showCommunityDoctor() != 0) {
                    ...
                    System.out.println("No existing Community Doctor.");
                }
            }
            ...
            if (option == 3) {
                ...
                if (HospitalDoctor.showHospitalDoctor() != 0) {
                    ...
                    System.out.println("No existing Hospital Doctor.");
                }
            }
            ...
            if (option == 4) {
                ...
                if (Diagnosis.showDiagnosis() != 0) {
                    ...
                    System.out.println("No diagnosis prescripted.");
                }
            }
            if (option == 5) {
                Main.template();
                if (Medication.showMedication() != 0) {
                    ...
                    System.out.println("No Medication prescripted.");
                }
            }
            if (option == 6) {
                Main.template();
                if (Surgery.showSurgery() != 0) {
                    ...
                    System.out.println("No surgery prescripted.");
                }
            }
            if (option == 0) menu();
        }
